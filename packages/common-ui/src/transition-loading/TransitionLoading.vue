...
const loadingRef = ref<HTMLDialogElement>(null!);
const showLoading = () => {
  loadingRef.value.classList.add("transition-loading-play");
};
...
onUnmounted(() => {
  if (loadingRef.value) {
    loadingRef.value.classList.remove("transition-loading-play");
  }
});
</script>

<template>
  <dialog ref="loadingRef" open class="transition-loading h-full w-full">
    <div class="content">
      <div class="loader">
        <div class="box box0">
          <div></div>
